...
pred <- bind_rows(
  readRDS(paste0('R/Eric_code/svm/svm_best_', sites.2.use, '.rds')) |> 
    mutate(type = 'best'),
  readRDS(paste0('R/Eric_code/svm/svm_ran_age_', sites.2.use, '.rds')) |> 
    mutate(type = 'ran.age'),
  readRDS(paste0('R/Eric_code/svm/svm_ran_age_meth_', sites.2.use, '.rds')) |> 
